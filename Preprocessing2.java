...
public class Preprocessing2 extends Configured implements Tool {
	...
	public static class KeyMapper01 extends Mapper<Text,Text,Text,Text> {
	...
	public int run (String[] args) throws Exception {
	    ...
	    ChainMapper.addMapper(job, KeyMapper01.class, Text.class, Text.class, Text.class, Text.class, KeyMapper01Config);
	...
	public static void main(String[] args) {
		try {
			int res = ToolRunner.run(conf, new Preprocessing2(), args);
			System.exit(res);
		} catch (Exception e) {
			e.printStackTrace();
		}
